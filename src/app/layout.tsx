...
export const metadata: Metadata = {
  title: "Stickman Director",
  description:
    "Turn English copy into a six-scene stickman video plan and six Gemini Omni Flash prompts. Inspired by kaomei/stickman-video-director.",
};
